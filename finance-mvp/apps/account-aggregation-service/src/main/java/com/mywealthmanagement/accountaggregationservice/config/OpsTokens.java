...
public final class OpsTokens {
     ...
     * the customer-care read-only views of a member's linked accounts and transactions.
     */
    public static final String[] OPS_PATH_PREFIXES = {"/api/v1/aggregation/support/"};
