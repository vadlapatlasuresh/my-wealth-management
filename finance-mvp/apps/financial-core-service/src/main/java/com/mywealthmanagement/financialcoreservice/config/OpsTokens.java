...
public final class OpsTokens {
     ...
     * CPA marketplace moderation (approve/reject/verify listings), which is staff-only.
     * The rest of /api/v1/cpa/** is member-facing and stays on member tokens.
     */
    public static final String[] OPS_PATH_PREFIXES = {"/api/v1/cpa/admin/"};
