...
public record TaxEstimateInput(
    ...
    public TaxEstimateInput(FilingStatus filingStatus, BigDecimal grossIncome, BigDecimal adjustments,
        ...
        this(filingStatus, grossIncome, adjustments, itemizedDeductions, dependentsUnder17, withholding, null, null, null, null);
    }
    ...
    public TaxEstimateInput(FilingStatus filingStatus, BigDecimal grossIncome, BigDecimal adjustments,
        ...
        this(filingStatus, grossIncome, adjustments, itemizedDeductions, dependentsUnder17, withholding,
                selfEmploymentIncome, null, null, null);
    }
    ...
    public TaxEstimateInput(FilingStatus filingStatus, BigDecimal grossIncome, BigDecimal adjustments,
        ...
        this(filingStatus, grossIncome, adjustments, itemizedDeductions, dependentsUnder17, withholding,
                selfEmploymentIncome, qualifiedBusinessIncome, null, null);
    }
    ...
    public TaxEstimateInput(FilingStatus filingStatus, BigDecimal grossIncome, BigDecimal adjustments,
                            ...
                            BigDecimal longTermCapitalGains) {
        this(filingStatus, grossIncome, adjustments, itemizedDeductions, dependentsUnder17, withholding,
                selfEmploymentIncome, qualifiedBusinessIncome, longTermCapitalGains, null);
    }
}
