 ...
 * X-Internal-Key). Posts an in-app notification for My Business events and asks
...
public class NotificationClient {
    ...
    /** In-app + email (best-effort). {@code type} tags the in-app row, e.g. "BUSINESS". */
    public void notify(Long userId, String type, String title, String body) {
        ...
        try {
            ...
            log.warn("business notification to user {} failed: {}", userId, e.getMessage());
        }
    }
}
