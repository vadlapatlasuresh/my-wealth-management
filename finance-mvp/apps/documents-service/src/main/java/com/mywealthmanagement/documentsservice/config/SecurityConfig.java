...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers("/internal/**").permitAll() // guarded by X-Internal-Key in the controllers
                .requestMatchers("/actuator/**").permitAll() // metrics/health scraping
                // Public, token-based share access (recipient has no app account). Guarded by the
                // opaque share token + optional passcode inside the controller, not by JWT.
